...
// #ifdef USE_RTP_SETUP_VAR
extern int port_recv;
extern int port_send;
extern string port_status;
extern int create_sock_flag;
extern int continue_recv ;
extern int allow_send;
extern int server_shut;
extern int rtp;
extern int recv_sock;
extern int recv_sock_rtcp;
// #endif
/************ User controls and command line options ***********/
extern int            call_count                  _DEFVAL(0);
